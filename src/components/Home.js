        ...
        <Grid stackable container>
          ...
          <Grid.Row columns="two">
            <Grid.Column >
              ...
              <img id="snakePreviewImg" src={process.env.PUBLIC_URL + 'images/snakeImage.png'} alt="" onClick={() => window.location.href = `/snakegame`}/>
            </Grid.Column>
            <Grid.Column>
              <Header as="h3" textAlign="center">Breakout</Header>
              <img id="breakoutPreviewImg" src={process.env.PUBLIC_URL + 'images/breakoutImage.png'} alt="" onClick={() => window.location.href = `/breakout`}/>
            </Grid.Column>
          </Grid.Row>
      </Grid>
